...
export default function PayLinkCard({ order }: { order: OrderSummary }) {
  ...
  return (
    <section className="mt-4 overflow-hidden rounded-[1.35rem] border border-[rgba(200,105,58,0.2)] bg-surface shadow-[0_16px_48px_rgba(37,36,31,0.06)]">
      <div className="border-b border-[rgba(200,105,58,0.15)] bg-[linear-gradient(180deg,rgba(200,105,58,0.10),rgba(200,105,58,0.02))] px-4 py-4">
