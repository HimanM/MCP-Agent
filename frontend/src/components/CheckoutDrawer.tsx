...
function DrawerSection({
  ...
  return (
    <section className="space-y-3 rounded-2xl border border-border bg-surface p-4 shadow-[0_10px_30px_rgba(37,36,31,0.03)]">
      <div>
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <div className="space-y-4">
          <div className="rounded-2xl border border-border bg-gradient-to-br from-surface to-surface-2 p-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.16em] text-muted">Order summary</p>
                <h3 className="mt-1 text-lg font-semibold text-ink">{itemCount} {itemCount === 1 ? "item" : "items"}</h3>
          ...
          <DrawerSection
            title="Recipient"
            description="Who should receive the order?"
          >
          ...
          <DrawerSection
            title="Delivery"
            description="Use the exact delivery address and preferred city/date."
          >
          ...
          <DrawerSection
            title="Sender"
            description="This name appears as the sender on the order."
          >
            <div className="space-y-1.5">
          ...
          <DrawerSection
            title="Gift message"
            description="Optional note to print with the gift."
          >
            <textarea
